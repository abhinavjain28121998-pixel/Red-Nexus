    ...
    <div className="w-full bg-[#050505] pb-24">
      ...
      <div className="relative py-24 overflow-hidden isolate">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-12">
          ...
          >
            Decoding<span className="hidden md:inline"><br/></span>the<span className="text-red-500">_</span>Unknown
          </motion.h1>
          <motion.p 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center py-16">
          ...
          <div className="order-1 md:order-2">
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter italic text-white mb-6">Our<span className="text-red-500">_</span>Mission</h2>
            <p className="text-white/50 text-lg mb-6 leading-relaxed font-medium">
        ...
        <div className="py-24 border-t border-white/10 mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             ...
             <div key={i} className="bg-white/[0.02] p-8 border border-white/10 hover:border-white/30 transition-colors">
               ...
               <p className="text-white/50 text-sm font-medium">{pillar.desc}</p>
             </div>
           ))}
        </div>
      </div>
